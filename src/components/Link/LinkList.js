...
function LinkList(props) {
  ...
  function getLinks() {
    ...
    return linksRef
      ...
      // axios.get(`https://us-central1-fir-react-8f96a.cloudfunctions.net/linksPagination?offset=${offset}`)
      axios({
        method: 'get',
        url: `https://us-central1-fir-react-8f96a.cloudfunctions.net/linksPagination?offset=${offset}`,
        headers: {
      ...
      .then(response => {
        ...
        const lastLink = links[links.leq - 1];
        setLinks(links);
        setCursor(lastLink);
        setLoading(false);
      });
